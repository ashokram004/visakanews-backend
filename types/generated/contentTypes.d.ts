...
export interface ApiAdvertisementAdvertisement
  ...
  attributes: {
    ...
    position: Schema.Attribute.Enumeration<
      ['headerAd', 'leftHomeAd', 'rightHomeAd', 'articleAd']
    > &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiAnalyticAnalytic extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    sessionId: Schema.Attribute.String;
    timeStamp: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dynamicTabs: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiDynamicTabDynamicTab extends Struct.CollectionTypeSchema {
  collectionName: 'dynamic_tabs';
  info: {
    displayName: 'DynamicTab';
    pluralName: 'dynamic-tabs';
    singularName: 'dynamic-tab';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    highlighted: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
...
export interface ApiFlashItemFlashItem extends Struct.CollectionTypeSchema {
  collectionName: 'flash_news';
  info: {
    displayName: 'FlashNews';
    pluralName: 'flash-news';
    singularName: 'flash-item';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiProfileAchievementProfileAchievement
  extends Struct.CollectionTypeSchema {
  collectionName: 'profile_achievements';
  info: {
    displayName: 'ProfileAchievement';
    pluralName: 'profile-achievements';
    singularName: 'profile-achievement';
  };
  options: {
    draftAndPublish: true;
  };
